Public Class ViewRejectedRequisition
    ...
    Private Sub ViewApprovedRequisition_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.ViewApprovedRequisitionsTableAdapter.FillByAll(Me.IGontrol.ViewApprovedRequisitions, "REJECTED")
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        Me.ViewApprovedRequisitionsTableAdapter.FillByDepartment(Me.IGontrol.ViewApprovedRequisitions, "REJECTED", ComboBox1.Text)
    End Sub

    Private Sub DateTimePicker1_ValueChanged(sender As Object, e As EventArgs) Handles DateTimePicker1.ValueChanged
        Me.ViewApprovedRequisitionsTableAdapter.FillByDateOfAppvr(Me.IGontrol.ViewApprovedRequisitions, "REJECTED", DateTimePicker1.Text, DateTimePicker2.Text)
    End Sub
