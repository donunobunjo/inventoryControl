Public Class CentralIssuance
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        dtApprovedQty = Me.ItemMasterTableAdapter.GetDataByCheckApprovedQty(Trim(ComboBox4.Text), "CENTRAL")
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        For j = 0 To (Me.DataGridView1.RowCount - 1) - 1
            ...
            loc = "CENTRAL"
            typeoftrans = "CENTRALISSUANCE"
            major = "CENTRALISSUANCE"
            majorminor = "CENTRALISSUANCE"
            minor = "CENTRAL"
            detail = "CENTRAL ISSUANCE"
            ...
            Me.StockTableAdapter.InsertQuery(classs, brand, loc, destination, typeoftrans, detail, jobcardnum, jobCardDescription, recdate, source, destination, issued, reciepts, 0.0, 0.0, itemnum, itemname, partnum, recdate, major, major, minor, rate)
        Next
