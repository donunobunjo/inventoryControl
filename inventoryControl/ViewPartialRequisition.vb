Public Class ViewPartialRequisition
    ...
    Private Sub ViewApprovedRequisition_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.ViewApprovedRequisitionsTableAdapter.FillByAll(Me.IGontrol.ViewApprovedRequisitions, "PARTIAL")
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        Me.ViewApprovedRequisitionsTableAdapter.FillByDepartment(Me.IGontrol.ViewApprovedRequisitions, "PARTIAL", ComboBox1.Text)
    End Sub

    Private Sub DateTimePicker1_ValueChanged(sender As Object, e As EventArgs) Handles DateTimePicker1.ValueChanged
        Me.ViewApprovedRequisitionsTableAdapter.FillByDateOfAppvr(Me.IGontrol.ViewApprovedRequisitions, "PARTIAL", DateTimePicker1.Text, DateTimePicker2.Text)
    End Sub
